...
class CreateEstimateTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
    ...
    def test_post_estimate_success_response(self):
    ...
    def test_post_estimate_invalid_body(self):
    ...
    def test_get_estimate_unknown_request_404(self):
    ...
    def test_estimate_invalid_total_num_operations(self):
        test_request = self.test_request_body

        test_request["circuit"]["total_num_operations"] = -1
        # Post request
    ...
    def test_end_to_end_estimate(self):
        # Post request
        post_estimate_response = self.rest_client.post_request(
            self.test_request_body, self.api, self.test_header
        )
        expected_num_physical_qubits = 2965

        request_id = json.loads(post_estimate_response.content)["request_id"]
        retries = 0
