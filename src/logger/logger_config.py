...
config.read_file(open('config/server.conf'))
...
def get_logging_config():
    LOGGING_CONFIG = {
        ...
        "loggers": {
            ...
            "": {
                "level": (log_level if not os.getenv("LOG_LEVEL_APP") else os.getenv("LOG_LEVEL_APP")),
        ...
        "handlers": {
            ...
            "file": {
                ...
                "filename": (log_file if not os.getenv("LOG_FILE") else os.getenv("LOG_FILE")),
                "mode": "a",
                "maxBytes": 100000,
                "backupCount": 20,
            },
