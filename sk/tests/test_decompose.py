...
class CreateDecomposeTestCase(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        self.input_path = "sk/data/sk_input_test.qasm"
    ...
    def test_post_decompose_success_response(self):
    ...
    def test_post_decompose_invalid_body(self):
    ...
    def test_get_decompose_unknown_request_404(self):
    ...
    def test_decompose_invalid_circuit_path(self):
        test_request = self.test_request_body
    ...
    def test_end_to_end_decompose(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(result["request_id"], request_id)
        self.assertTrue(result["accumulated_error"] < accumulated_error_limit)
